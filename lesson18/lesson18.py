...
# А111А3А
# 1111ААА
# ожидаемый результат ? (фактический результат будет 1)
...
# # максимальное кол-во  букв А находится в последней строке
# # CAAA BB 1BCCC
# # C BB BCCC
# # CAAAAA1BBBCCC
# # ожидаемый результат 3
...
# print(count_nad_row)
# print(max(count_nad_row)+1)# нашлось
#-------------конец тест1----------------#
...
#     count_nad_row[row] = countA # добавляем или обновляем значение в словаре
# print(count_nad_row)
# print(max(count_nad_row)+1)# нашлось ищет максимальный ключ
...
#         count += 1
# print(count) # фактический результат 3
