...
"""
check_sides = lambda *sides: [ side<=0 for side in sides] 
...
with open('passwords.txt','r') as f:
    ...
    for password in passwords:       
        ...
        for el in password:
            if (' ' in password) and  ('\t' in password): #В пароле не должно быть пробелов, табуляции(\t), все остальные остальные символы допустимы
                break
